...
// Baseline (standard FPU): Cfg.EnablePrivateFpu is 1 on this branch, so
// every core gets its own private, non-PACE cv32e40p_fp_wrapper/fpnew_top
// instance (PaceFeatures.FmtConfig is zeroed in cv32e40p_fp_wrapper.sv, so
// fpnew elaborates fpnew_fma_multi, not fpnew_pace_fma_multi). 
generate
