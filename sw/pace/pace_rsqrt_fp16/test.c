/*
 * PACE RSQRT test on the PULP cluster.
 *
...
int main(void) {
  ...
  // 3) PACE_S (FP16): opcode=0x53 (OP-FP), funct3=0x0 (rm=RNE), funct7=0x3c
  //    (funct5=01111, fmt=10). PACE reads operand 0, so the input goes in rs1;
  ...
  //      PACE_S  fa1,fa0,fa2 0x7cc505d3   (0x3c<<25)|(12<<20)|(10<<15)|(11<<7)|0x53
