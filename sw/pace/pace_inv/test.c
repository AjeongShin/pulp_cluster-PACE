/*
 * PACE inverse test on the PULP cluster.
 *
...
int main(void) {
  ...
  // 3) PACE_S (FP32): opcode=0x53 (OP-FP), funct3=0x0 (rm=RNE), funct7=0x34
  //    (funct5=01101, fmt=00). PACE reads operand 0, so the input goes in rs1;
  ...
  //      PACE_S  fa1,fa0,fa2 0x68c505d3   (0x34<<25)|(12<<20)|(10<<15)|(11<<7)|0x53
