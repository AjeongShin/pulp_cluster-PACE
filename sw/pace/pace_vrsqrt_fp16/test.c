/*
 * PACE vectorial rsqrt test in FP16 on the PULP cluster.
 *
...
int main(void) {
  ...
  //      vpace.h  fa1, fa0    0xbe0525b3   instr[29:27]=111 (PACE), [26:25]=11 (rsqrt),
  //                                        [13:12]=10 (FP16)
  ...
  printf("PACE vector rsqrt FP16 errors = %d\n", errors);
  return errors;
}
