/*
 * PACE inverse test in FP16 on the PULP cluster.
 *
...
int main(void) {
  ...
  // 3) PACE_H (FP16): opcode=0x53 (OP-FP), funct3=0x0 (rm=RNE), funct7=0x36
  //    (funct5=01101 inv, fmt=10 FP16). PACE reads operand 0, so the input goes in rs1;
  ...
  //      fmv.h.x fa2, x0     0xf4000653   zeroes rs2. Not required: the scalar decoder
  ...
  //      PACE_H  fa1,fa0,fa2 0x6cc505d3   funct5 01101 (inv), fmt 10 (FP16)
